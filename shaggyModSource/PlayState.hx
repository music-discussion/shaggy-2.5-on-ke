...
class PlayState extends MusicBeatState
{
	...
	override public function create()
	{
		...
		if (SONG.song.toLowerCase() == 'live-on' || SONG.song.toLowerCase() == 'big-shot' || SONG.song.toLowerCase() == 'whats-bugged' || SONG.song.toLowerCase() == 'infinite-songs' || SONG.song.toLowerCase() == 'sweet-sauce')
		{
