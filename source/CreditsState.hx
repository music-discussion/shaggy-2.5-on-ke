...
class CreditsState extends MusicBeatState
{
	...
	private static var creditsStuff:Array<Dynamic> = [ //Name - Icon name - Description - Link - BG Color
		...
		['Mod Porter'],
		['Discussions', 		'discussions', 			'The Coder that Ported', 						'https://gamebanana.com/members/1900848', 0xFF57E88A],
		['The Shaggy mod'],
		...
		['TheZoroForce', 		'thezoroforce', 	'Helped With A few Things', 						'https://gamebanana.com/members/1708748', 0xFFFF8D18],
		['The Pound', 		'discord', 	'Join HeckinLeBork\'s Discord Server!', 						'https://discord.gg/7mHaNysx7c', 0xFF0051FF],
		[''],
		['Psych Engine Team'],
