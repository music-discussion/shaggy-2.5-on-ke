...
class UnownSubState extends MusicBeatSubstate
{
	...
	var onePercentWords:Array<String> = [
		...
		'BUSSY',
        'SUSSY BAKA',
        'I TOUCHED HER SOFT SOMETHING',
        'HER CHEST FEELS SOFT',
        'NINJAMUFFIN',
        'FNF',
		'LOCA',
		...
		'WE DONT SLEEP',
		'WE DONT DIE',
		'SlEEPING THE BURRENS',
		'WE JUST WANNA BE LIKE BRUH',
	...
	var zeropointonePercentWords:Array<String> = [
		...
		'HI ASH',
        'WELCOME VIEWERS',
        'WANNA HELP MAKE SOME SHAGGY SONGS?',
        'ITS ALREADY OVER',
        'YOUR STORY ENDS HERE',
        'WHERES ZARDY WHEN YOU NEED HIM?',

		///////////////////////////////////////////////  totally not stolen from a song or anything.
		...
		'HEY HEY HEY',
		'WHATS YOUR CLOTHES DOING HERE?',
		'IM NOT YOUR BOYFRIEND DEAR',
		'I DONT WANT YOU HERE NO MORE',

		'EH EH EH',
		'EVERY TIME WE FIGHT',
		'THATS A GAME YOU LIKE',
		'I DONT WANT YOU HERE NO MORE',
	...
	var hellModeWords:Array<String> = [
		...
		'KEK',
        'MAYBE WBSHAGGY WILL HELP'
	];

	var fuckYouWords:Array<String> = [ //never used in game. placeholder I assume.
		'FUCK YOU',
		'COPE SEETHE',
		'VAGINA MOUTH'
	];
	...
	public function new(theTimer:Int = 15, word:String = '')
	{
		...
		for (i in 0...selectedWord.length) {
			if (!selectedWord.isSpace(i)) 
			{
				...
				unown.updateHitbox();
				if (!PauseSubState.englishWords)
					unown.frames = Paths.getSparrowAtlas('Unown_Alphabet', 'shared');
				else 
					unown.frames = Paths.getSparrowAtlas('Unown_Alphabet_ENGLISH', 'shared');
